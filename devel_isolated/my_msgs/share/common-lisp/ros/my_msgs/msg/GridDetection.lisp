...
(cl:defmethod cl:initialize-instance :after ((m <GridDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<GridDetection> is deprecated: use my_msgs-msg:GridDetection instead.")))
...
(cl:defmethod row1-val ((m <GridDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:row1-val is deprecated.  Use my_msgs-msg:row1 instead.")
  (row1 m))

(cl:ensure-generic-function 'row2-val :lambda-list '(m))
(cl:defmethod row2-val ((m <GridDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:row2-val is deprecated.  Use my_msgs-msg:row2 instead.")
  (row2 m))

(cl:ensure-generic-function 'row3-val :lambda-list '(m))
(cl:defmethod row3-val ((m <GridDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:row3-val is deprecated.  Use my_msgs-msg:row3 instead.")
  (row3 m))
