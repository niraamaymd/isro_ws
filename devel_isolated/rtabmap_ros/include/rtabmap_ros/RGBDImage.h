...
struct RGBDImage_
{
  ...
  _depth_compressed_type depth_compressed;
   ...
   typedef std::vector< ::rtabmap_ros::KeyPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::KeyPoint_<ContainerAllocator> >> _key_points_type;
  _key_points_type key_points;

   typedef std::vector< ::rtabmap_ros::Point3f_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::Point3f_<ContainerAllocator> >> _points_type;
  _points_type points;
