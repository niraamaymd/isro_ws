...
struct MapGraph_
{
  ...
  _poses_type poses;
   ...
   typedef std::vector< ::rtabmap_ros::Link_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::Link_<ContainerAllocator> >> _links_type;
  _links_type links;
