...
struct NodeData_
{
  ...
  _grid_view_point_type grid_view_point;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _wordIds_type;
  _wordIds_type wordIds;

   typedef std::vector< ::rtabmap_ros::KeyPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::KeyPoint_<ContainerAllocator> >> _wordKpts_type;
  _wordKpts_type wordKpts;

   typedef std::vector< ::rtabmap_ros::Point3f_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::Point3f_<ContainerAllocator> >> _wordPts_type;
  ...
  _wordDescriptors_type wordDescriptors;
   ...
   typedef std::vector< ::rtabmap_ros::GlobalDescriptor_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::GlobalDescriptor_<ContainerAllocator> >> _globalDescriptors_type;
  _globalDescriptors_type globalDescriptors;

   typedef std::vector< ::rtabmap_ros::EnvSensor_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::EnvSensor_<ContainerAllocator> >> _env_sensors_type;
