...
struct MapData_
{
  ...
  _graph_type graph;
   ...
   typedef std::vector< ::rtabmap_ros::NodeData_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rtabmap_ros::NodeData_<ContainerAllocator> >> _nodes_type;
  _nodes_type nodes;
