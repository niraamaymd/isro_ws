...
struct OdomInfo_
{
  ...
  _localMapValues_type localMapValues;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _localScanMap_type;
...
bool operator==(const ::rtabmap_ros::OdomInfo_<ContainerAllocator1> & lhs, const ::rtabmap_ros::OdomInfo_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.localScanMapFormat == rhs.localScanMapFormat &&
