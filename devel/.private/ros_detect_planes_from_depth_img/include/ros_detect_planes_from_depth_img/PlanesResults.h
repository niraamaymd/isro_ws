...
struct PlanesResults_
{
  ...
  _N_type N;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _norms_type;
  _norms_type norms;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _center_3d_type;
  _center_3d_type center_3d;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _center_2d_type;
  _center_2d_type center_2d;

   typedef std::vector<uint16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint16_t>> _mask_color_type;
