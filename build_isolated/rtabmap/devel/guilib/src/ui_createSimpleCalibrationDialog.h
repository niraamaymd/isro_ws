...
public:
    ...
    {
        createSimpleCalibrationDialog->setWindowTitle(QApplication::translate("createSimpleCalibrationDialog", "Create simple calibration", Q_NULLPTR));
        comboBox_advanced->clear();
        comboBox_advanced->insertItems(0, QStringList()
         << QApplication::translate("createSimpleCalibrationDialog", "Basic (images are already rectified)", Q_NULLPTR)
         << QApplication::translate("createSimpleCalibrationDialog", "Advanced (images should be rectified)", Q_NULLPTR)
        );
        checkBox_stereo->setText(QApplication::translate("createSimpleCalibrationDialog", "Stereo", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Camera Intrinsics", Q_NULLPTR));
        label_2->setText(QApplication::translate("createSimpleCalibrationDialog", "fy", Q_NULLPTR));
        label_baseline->setText(QApplication::translate("createSimpleCalibrationDialog", "baseline (m)", Q_NULLPTR));
        label_3->setText(QApplication::translate("createSimpleCalibrationDialog", "cx", Q_NULLPTR));
        label_4->setText(QApplication::translate("createSimpleCalibrationDialog", "cy", Q_NULLPTR));
        label->setText(QApplication::translate("createSimpleCalibrationDialog", "fx", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Camera Intrinsics", Q_NULLPTR));
        label_left->setText(QApplication::translate("createSimpleCalibrationDialog", "Left", Q_NULLPTR));
        label_right->setText(QApplication::translate("createSimpleCalibrationDialog", "Right", Q_NULLPTR));
        label_10->setText(QApplication::translate("createSimpleCalibrationDialog", "fx", Q_NULLPTR));
        label_9->setText(QApplication::translate("createSimpleCalibrationDialog", "fy", Q_NULLPTR));
        label_8->setText(QApplication::translate("createSimpleCalibrationDialog", "cy", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_12->setToolTip(QApplication::translate("createSimpleCalibrationDialog", "k1, k2, p1, p2[, k3[, k4, k5, k6 ]]", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_12->setText(QApplication::translate("createSimpleCalibrationDialog", "Distorsion coefficients (4, 5 or 8 values)", Q_NULLPTR));
        label_11->setText(QApplication::translate("createSimpleCalibrationDialog", "cx", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Image Size", Q_NULLPTR));
        label_5->setText(QApplication::translate("createSimpleCalibrationDialog", "Image width", Q_NULLPTR));
        label_13->setText(QApplication::translate("createSimpleCalibrationDialog", "Image height", Q_NULLPTR));
        groupBox_stereo_extrinsics->setTitle(QApplication::translate("createSimpleCalibrationDialog", "Stereo Camera Extrinsics", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        lineEdit_RT->setToolTip(QApplication::translate("createSimpleCalibrationDialog", "<html><head/><body><p>Format (3 values): x y z<br/>Format (6 values): x y z roll pitch yaw<br/>Format (7 values): x y z qx qy qz qw<br/>Format (9 values, 3x3 rotation): r11 r12 r13 r21 r22 r23 r31 r32 r33<br/>Format (12 values, 3x4 transform): r11 r12 r13 tx r21 r22 r23 ty r31 r32 r33 tz</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_6->setText(QApplication::translate("createSimpleCalibrationDialog", "Transform between the cameras used for stereo rectification.", Q_NULLPTR));
    } // retranslateUi
