...
void rtabmap::CreateSimpleCalibrationDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CreateSimpleCalibrationDialog *_t = static_cast<CreateSimpleCalibrationDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject rtabmap::CreateSimpleCalibrationDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_rtabmap__CreateSimpleCalibrationDialog.data,
      qt_meta_data_rtabmap__CreateSimpleCalibrationDialog,  qt_static_metacall, nullptr, nullptr}
};
