...
void rtabmap::StatItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StatItem::*_t)(qreal );
        ...
        {
            typedef void (StatItem::*_t)(qreal , qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StatItem::valueAdded)) {
                *result = 1;
                return;
            }
        ...
        {
            typedef void (StatItem::*_t)(const std::vector<qreal> & , const std::vector<qreal> & );
        ...
        {
            typedef void (StatItem::*_t)(const StatItem * , const QString & );
...
const QMetaObject rtabmap::StatItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rtabmap__StatItem.data,
      qt_meta_data_rtabmap__StatItem,  qt_static_metacall, nullptr, nullptr}
};
...
void rtabmap::StatsToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (StatsToolBox::*_t)(const QMenu * );
...
const QMetaObject rtabmap::StatsToolBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_rtabmap__StatsToolBox.data,
      qt_meta_data_rtabmap__StatsToolBox,  qt_static_metacall, nullptr, nullptr}
};
