...
public:
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 422, 311));
        ...
        gridLayout->addWidget(label_childrenA_16, 11, 0, 1, 1);
        ...
        gridLayout->addWidget(label_gpsA, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(label_childrenA_20, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(label_sensorsA, 12, 1, 1, 1);
        ...
        label_childrenA_24->setObjectName(QStringLiteral("label_childrenA_24"));

        gridLayout->addWidget(label_childrenA_24, 10, 0, 1, 1);

        label_gravityA = new QLabel(scrollAreaWidgetContents_2);
        label_gravityA->setObjectName(QStringLiteral("label_gravityA"));
        label_gravityA->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout->addWidget(label_gravityA, 10, 1, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 421, 311));
        ...
        gridLayout_2->addWidget(label_childrenA_17, 11, 0, 1, 1);
        ...
        gridLayout_2->addWidget(label_gpsB, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(label_childrenA_21, 12, 0, 1, 1);
        ...
        gridLayout_2->addWidget(label_sensorsB, 12, 1, 1, 1);
        ...
        label_childrenA_25->setObjectName(QStringLiteral("label_childrenA_25"));

        gridLayout_2->addWidget(label_childrenA_25, 10, 0, 1, 1);

        label_gravityB = new QLabel(scrollAreaWidgetContents);
        label_gravityB->setObjectName(QStringLiteral("label_gravityB"));
        label_gravityB->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(label_gravityB, 10, 1, 1, 1);
        ...
        toolButton_constraint->setObjectName(QStringLiteral("toolButton_constraint"));
        ...
        checkBox_enableForAll->setObjectName(QStringLiteral("checkBox_enableForAll"));
        ...
        checkBox_ignoreLandmarks->setObjectName(QStringLiteral("checkBox_ignoreLandmarks"));
        ...
        page_4->setGeometry(QRect(0, 0, 519, 871));
        ...
        gridLayout_9->addWidget(label_57, 13, 1, 1, 1);

        spinBox_cropRadius = new QSpinBox(page_4);
        spinBox_cropRadius->setObjectName(QStringLiteral("spinBox_cropRadius"));
        spinBox_cropRadius->setValue(1);

        gridLayout_9->addWidget(spinBox_cropRadius, 13, 0, 1, 1);

        label_59 = new QLabel(page_4);
        label_59->setObjectName(QStringLiteral("label_59"));
        label_59->setWordWrap(true);

        gridLayout_9->addWidget(label_59, 14, 1, 1, 1);

        checkBox_grid_showProbMap = new QCheckBox(page_4);
        checkBox_grid_showProbMap->setObjectName(QStringLiteral("checkBox_grid_showProbMap"));
        checkBox_grid_showProbMap->setChecked(false);

        gridLayout_9->addWidget(checkBox_grid_showProbMap, 14, 0, 1, 1);
        ...
        page_5->setGeometry(QRect(0, 0, 312, 243));
        ...
        doubleSpinBox_detectMore_radiusMin->setObjectName(QStringLiteral("doubleSpinBox_detectMore_radiusMin"));
        doubleSpinBox_detectMore_radiusMin->setDecimals(2);
        doubleSpinBox_detectMore_radiusMin->setMaximum(10);
        doubleSpinBox_detectMore_radiusMin->setSingleStep(0.1);
        doubleSpinBox_detectMore_radiusMin->setValue(0);
        ...
        checkBox_gravity_3dview->setObjectName(QStringLiteral("checkBox_gravity_3dview"));
    ...
    {
        DatabaseViewer->setWindowTitle(QApplication::translate("DatabaseViewer", "Database viewer", Q_NULLPTR));
        actionOpen_database->setText(QApplication::translate("DatabaseViewer", "Open database", Q_NULLPTR));
        actionQuit->setText(QApplication::translate("DatabaseViewer", "Quit", Q_NULLPTR));
        actionGenerate_graph_dot->setText(QApplication::translate("DatabaseViewer", "Generate graph (*.dot) ...", Q_NULLPTR));
        actionGenerate_local_graph_dot->setText(QApplication::translate("DatabaseViewer", "Generate local graph (.dot) ...", Q_NULLPTR));
        actionGenerate_3D_map_pcd->setText(QApplication::translate("DatabaseViewer", "Export 3D map (*.ply *.pcd) ...", Q_NULLPTR));
        actionExport->setText(QApplication::translate("DatabaseViewer", "Export database...", Q_NULLPTR));
        actionExtract_images->setText(QApplication::translate("DatabaseViewer", "Extract images...", Q_NULLPTR));
        actionView_3D_map->setText(QApplication::translate("DatabaseViewer", "View 3D map...", Q_NULLPTR));
        actionRefine_all_neighbor_links->setText(QApplication::translate("DatabaseViewer", "Refine all neighbor links...", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionRefine_all_neighbor_links->setToolTip(QApplication::translate("DatabaseViewer", "Refine all neighbor links with the registration strategy set in \"Core Parameters\"->\"Reg\"", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionRefine_all_loop_closure_links->setText(QApplication::translate("DatabaseViewer", "Refine all loop closure links...", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionRefine_all_loop_closure_links->setToolTip(QApplication::translate("DatabaseViewer", "Refine all loop closure links with the registration strategy set in \"Core Parameters\"->\"Reg\"", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionDetect_more_loop_closures->setText(QApplication::translate("DatabaseViewer", "Detect more loop closures...", Q_NULLPTR));
        actionSave_config->setText(QApplication::translate("DatabaseViewer", "Save config", Q_NULLPTR));
        actionReset_all_changes->setText(QApplication::translate("DatabaseViewer", "Reset link and grid map changes", Q_NULLPTR));
        actionRegenerate_local_grid_maps->setText(QApplication::translate("DatabaseViewer", "Regenerate local grid maps...", Q_NULLPTR));
        actionRegenerate_local_grid_maps_selected->setText(QApplication::translate("DatabaseViewer", "Regenerate local grid maps (selected)...", Q_NULLPTR));
        actionEdit_depth_image->setText(QApplication::translate("DatabaseViewer", "Edit depth image...", Q_NULLPTR));
        actionVertical_Layout->setText(QApplication::translate("DatabaseViewer", "Vertical Layout", Q_NULLPTR));
        actionRestore_default_GUI_settings->setText(QApplication::translate("DatabaseViewer", "Restore default GUI settings", Q_NULLPTR));
        actionRaw_format_txt->setText(QApplication::translate("DatabaseViewer", "Raw format (*.txt)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionRaw_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "Raw format (12 values transform)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setText(QApplication::translate("DatabaseViewer", "RGBD-SLAM format (*.txt)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionKITTI_format_txt->setText(QApplication::translate("DatabaseViewer", "KITTI format (*.txt)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionKITTI_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "KITTI (stamp + 12 values transform)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionTORO_graph->setText(QApplication::translate("DatabaseViewer", "TORO (*.graph)", Q_NULLPTR));
        actionG2o_g2o->setText(QApplication::translate("DatabaseViewer", "g2o (*.g2o)", Q_NULLPTR));
        actionGPS_KML->setText(QApplication::translate("DatabaseViewer", "Google Earth (*.kml)", Q_NULLPTR));
        actionGPS_TXT->setText(QApplication::translate("DatabaseViewer", "Raw format (*.txt)", Q_NULLPTR));
        actionPoses_KML->setText(QApplication::translate("DatabaseViewer", "Google Earth (*.kml)", Q_NULLPTR));
        actionDatabase_recovery->setText(QApplication::translate("DatabaseViewer", "Database recovery", Q_NULLPTR));
        actionClose_database->setText(QApplication::translate("DatabaseViewer", "Close database", Q_NULLPTR));
        actionExport_saved_2D_map->setText(QApplication::translate("DatabaseViewer", "Export optimized 2D map...", Q_NULLPTR));
        actionImport_2D_map->setText(QApplication::translate("DatabaseViewer", "Import optimized 2D map...", Q_NULLPTR));
        actionView_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "View optimized mesh", Q_NULLPTR));
        actionExport_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "Export optimized mesh...", Q_NULLPTR));
        actionUpdate_optimized_mesh->setText(QApplication::translate("DatabaseViewer", "Update optimized mesh...", Q_NULLPTR));
        actionUpdate_all_neighbor_covariances->setText(QApplication::translate("DatabaseViewer", "Update all neighbor covariances...", Q_NULLPTR));
        actionUpdate_all_loop_closure_covariances->setText(QApplication::translate("DatabaseViewer", "Update all loop closure covariances...", Q_NULLPTR));
        actionRGBD_SLAM_motion_capture_format_txt->setText(QApplication::translate("DatabaseViewer", "RGBD-SLAM motion capture format (*.txt)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actionRGBD_SLAM_motion_capture_format_txt->setToolTip(QApplication::translate("DatabaseViewer", "RGBD-SLAM (stamp tx ty tz qx qy qz qw)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        actionEdit_optimized_2D_map->setText(QApplication::translate("DatabaseViewer", "Edit optimized 2D map...", Q_NULLPTR));
        actionRegenerate_optimized_2D_map->setText(QApplication::translate("DatabaseViewer", "Regenerate optimized 2D map...", Q_NULLPTR));
        label_poseA->setText(QString());
        label_childrenA_2->setText(QApplication::translate("DatabaseViewer", "Children", Q_NULLPTR));
        label_parentsA->setText(QString());
        label_parentsA_2->setText(QApplication::translate("DatabaseViewer", "Parents", Q_NULLPTR));
        label_childrenA_12->setText(QApplication::translate("DatabaseViewer", "Pose", Q_NULLPTR));
        label_mapA->setText(QString());
        label_childrenA_10->setText(QApplication::translate("DatabaseViewer", "Map ID", Q_NULLPTR));
        label_childrenA_14->setText(QApplication::translate("DatabaseViewer", "Calib", Q_NULLPTR));
        label_calibA->setText(QString());
        label_childrenA->setText(QString());
        label_childrenA_4->setText(QApplication::translate("DatabaseViewer", "Label", Q_NULLPTR));
        label_labelA->setText(QString());
        label_childrenA_6->setText(QApplication::translate("DatabaseViewer", "Stamp", Q_NULLPTR));
        label_stampA->setText(QString());
        label_childrenA_8->setText(QApplication::translate("DatabaseViewer", "Weight", Q_NULLPTR));
        label_weightA->setText(QString());
        label_childrenA_16->setText(QApplication::translate("DatabaseViewer", "GPS", Q_NULLPTR));
        label_gpsA->setText(QString());
        label_childrenA_18->setText(QApplication::translate("DatabaseViewer", "Velocity", Q_NULLPTR));
        label_velA->setText(QString());
        label_childrenA_20->setText(QApplication::translate("DatabaseViewer", "Sensors", Q_NULLPTR));
        label_sensorsA->setText(QString());
        label_childrenA_22->setText(QApplication::translate("DatabaseViewer", "Scan", Q_NULLPTR));
        label_scanA->setText(QString());
        label_childrenA_24->setText(QApplication::translate("DatabaseViewer", "Gravity", Q_NULLPTR));
        label_gravityA->setText(QString());
        label_childrenA_9->setText(QApplication::translate("DatabaseViewer", "Weight", Q_NULLPTR));
        label_mapB->setText(QString());
        label_poseB->setText(QString());
        label_childrenA_15->setText(QApplication::translate("DatabaseViewer", "Calib", Q_NULLPTR));
        label_calibB->setText(QString());
        label_childrenA_17->setText(QApplication::translate("DatabaseViewer", "GPS", Q_NULLPTR));
        label_gpsB->setText(QString());
        label_childrenB->setText(QString());
        label_childrenA_5->setText(QApplication::translate("DatabaseViewer", "Label", Q_NULLPTR));
        label_labelB->setText(QString());
        label_weightB->setText(QString());
        label_childrenA_11->setText(QApplication::translate("DatabaseViewer", "Map ID", Q_NULLPTR));
        label_childrenA_13->setText(QApplication::translate("DatabaseViewer", "Pose", Q_NULLPTR));
        label_parentsB->setText(QString());
        label_parentsA_4->setText(QApplication::translate("DatabaseViewer", "Parents", Q_NULLPTR));
        label_childrenA_3->setText(QApplication::translate("DatabaseViewer", "Children", Q_NULLPTR));
        label_childrenA_7->setText(QApplication::translate("DatabaseViewer", "Stamp", Q_NULLPTR));
        label_stampB->setText(QString());
        label_childrenA_19->setText(QApplication::translate("DatabaseViewer", "Velocity", Q_NULLPTR));
        label_velB->setText(QString());
        label_childrenA_21->setText(QApplication::translate("DatabaseViewer", "Sensors", Q_NULLPTR));
        label_sensorsB->setText(QString());
        label_childrenA_23->setText(QApplication::translate("DatabaseViewer", "Scan", Q_NULLPTR));
        label_scanB->setText(QString());
        label_childrenA_25->setText(QApplication::translate("DatabaseViewer", "Gravity", Q_NULLPTR));
        label_gravityB->setText(QString());
        label_2->setText(QApplication::translate("DatabaseViewer", "Index :", Q_NULLPTR));
        label_3->setText(QApplication::translate("DatabaseViewer", "Id :", Q_NULLPTR));
        label_indexA->setText(QApplication::translate("DatabaseViewer", "indexA", Q_NULLPTR));
        label_idA->setText(QApplication::translate("DatabaseViewer", "idA", Q_NULLPTR));
        label_5->setText(QApplication::translate("DatabaseViewer", "Index :", Q_NULLPTR));
        label_4->setText(QApplication::translate("DatabaseViewer", "Id :", Q_NULLPTR));
        label_indexB->setText(QApplication::translate("DatabaseViewer", "indexB", Q_NULLPTR));
        label_idB->setText(QApplication::translate("DatabaseViewer", "idB", Q_NULLPTR));
        menuFile->setTitle(QApplication::translate("DatabaseViewer", "File", Q_NULLPTR));
        menuExport_poses->setTitle(QApplication::translate("DatabaseViewer", "Export poses...", Q_NULLPTR));
        menuExport_GPS->setTitle(QApplication::translate("DatabaseViewer", "Export GPS...", Q_NULLPTR));
        menuEdit->setTitle(QApplication::translate("DatabaseViewer", "Edit", Q_NULLPTR));
        menuView->setTitle(QApplication::translate("DatabaseViewer", "View", Q_NULLPTR));
        dockWidget_constraints->setWindowTitle(QApplication::translate("DatabaseViewer", "Constraints view", Q_NULLPTR));
        checkBox_show3DWords->setText(QApplication::translate("DatabaseViewer", "Words", Q_NULLPTR));
        checkBox_show3Dclouds->setText(QApplication::translate("DatabaseViewer", "Clouds", Q_NULLPTR));
        checkBox_show2DScans->setText(QApplication::translate("DatabaseViewer", "Scans", Q_NULLPTR));
        checkBox_odomFrame->setText(QApplication::translate("DatabaseViewer", "Odom Frame", Q_NULLPTR));
        label_variance->setText(QString());
        label->setText(QApplication::translate("DatabaseViewer", "Neighbor links", Q_NULLPTR));
        label_6->setText(QApplication::translate("DatabaseViewer", "Loop closure links", Q_NULLPTR));
        label_33->setText(QApplication::translate("DatabaseViewer", "Type", Q_NULLPTR));
        checkBox_showOptimized->setText(QApplication::translate("DatabaseViewer", "Optimized", Q_NULLPTR));
        label_constraint_opt->setText(QString());
        label_18->setText(QApplication::translate("DatabaseViewer", "\317\203 (lin, ang), cov", Q_NULLPTR));
        label_type->setText(QString());
        label_type_name->setText(QString());
        label_constraint->setText(QString());
#ifndef QT_NO_TOOLTIP
        toolButton_constraint->setToolTip(QApplication::translate("DatabaseViewer", "Edit Constraint", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        toolButton_constraint->setText(QApplication::translate("DatabaseViewer", "...", Q_NULLPTR));
        label_16->setText(QApplication::translate("DatabaseViewer", "Transform", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pushButton_refine->setToolTip(QApplication::translate("DatabaseViewer", "Refine with the registration strategy set in \"Core Parameters\"->\"Reg\"", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pushButton_refine->setText(QApplication::translate("DatabaseViewer", "Refine", Q_NULLPTR));
        pushButton_reset->setText(QApplication::translate("DatabaseViewer", "Reset", Q_NULLPTR));
        pushButton_add->setText(QApplication::translate("DatabaseViewer", "Add", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBox_enableForAll->setToolTip(QApplication::translate("DatabaseViewer", "Enable \"Add\" for all nodes (even not in graph)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBox_enableForAll->setText(QString());
        pushButton_reject->setText(QApplication::translate("DatabaseViewer", "Reject", Q_NULLPTR));
        dockWidget_graphView->setWindowTitle(QApplication::translate("DatabaseViewer", "Graph view", Q_NULLPTR));
        label_iterations->setText(QApplication::translate("DatabaseViewer", "#", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBox_iterativeOptimization->setToolTip(QApplication::translate("DatabaseViewer", "Iterative optimization. Intermediate optimization graphes will be computed. Depending on the graph optimizer used, final optimization may not give the same results.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label_52->setText(QApplication::translate("DatabaseViewer", "Poses", Q_NULLPTR));
        label_39->setText(QApplication::translate("DatabaseViewer", "Time optimization (s)", Q_NULLPTR));
        label_41->setText(QApplication::translate("DatabaseViewer", "Links (N, NM, G, LS, LT, U, P, LM, GR)", Q_NULLPTR));
        label_10->setText(QApplication::translate("DatabaseViewer", "Path length (m)", Q_NULLPTR));
        label_45->setText(QApplication::translate("DatabaseViewer", "Time grid (s)", Q_NULLPTR));
        label_pathLength->setText(QString());
        label_optimizeFrom->setText(QApplication::translate("DatabaseViewer", "Root", Q_NULLPTR));
        checkBox_spanAllMaps->setText(QApplication::translate("DatabaseViewer", "Span to all maps", Q_NULLPTR));
        checkBox_wmState->setText(QApplication::translate("DatabaseViewer", "WM", Q_NULLPTR));
        label_poses->setText(QString());
        label_alignPosesWithGroundTruth->setText(QApplication::translate("DatabaseViewer", "Align poses with ground truth", Q_NULLPTR));
        ...
        label_ignoreINtermediateNdoes->setText(QApplication::translate("DatabaseViewer", "Ignore intermediate nodes", Q_NULLPTR));
        label_rmse_title->setText(QApplication::translate("DatabaseViewer", "RMSE (m)", Q_NULLPTR));
        label_alignScansCloudsWithGroundTruth->setText(QApplication::translate("DatabaseViewer", "Align scans/clouds with ground truth", Q_NULLPTR));
        checkBox_alignScansCloudsWithGroundTruth->setText(QString());
        dockWidget_guiparameters->setWindowTitle(QApplication::translate("DatabaseViewer", "GUI Parameters", Q_NULLPTR));
        comboBox_logger_level->clear();
        comboBox_logger_level->insertItems(0, QStringList()
         << QApplication::translate("DatabaseViewer", "Debug", Q_NULLPTR)
         << QApplication::translate("DatabaseViewer", "Info", Q_NULLPTR)
         << QApplication::translate("DatabaseViewer", "Warning", Q_NULLPTR)
         << QApplication::translate("DatabaseViewer", "Error", Q_NULLPTR)
        );
        label_logger_level->setText(QApplication::translate("DatabaseViewer", "Logger level", Q_NULLPTR));
        checkBox_ignoreGlobalLoop->setText(QString());
        label_49->setText(QApplication::translate("DatabaseViewer", "Ignore local loop closures (time)", Q_NULLPTR));
        checkBox_ignoreLocalLoopSpace->setText(QString());
        label_48->setText(QApplication::translate("DatabaseViewer", "Ignore global loop closures", Q_NULLPTR));
        label_35->setText(QApplication::translate("DatabaseViewer", "Ignore pose correction", Q_NULLPTR));
        ...
        label_50->setText(QApplication::translate("DatabaseViewer", "Ignore user loop closures", Q_NULLPTR));
        label_47->setText(QApplication::translate("DatabaseViewer", "Ignore local loop closures (space)", Q_NULLPTR));
        label_scale_title->setText(QApplication::translate("DatabaseViewer", "Scale", Q_NULLPTR));
        label_58->setText(QApplication::translate("DatabaseViewer", "Ignore landmarks", Q_NULLPTR));
        checkBox_ignoreLandmarks->setText(QString());
        toolBox->setItemText(toolBox->indexOf(page_3), QApplication::translate("DatabaseViewer", "Graph optimization", Q_NULLPTR));
        label_octomap_cubes->setText(QApplication::translate("DatabaseViewer", "OctoMap: Rendering type", Q_NULLPTR));
        label_51->setText(QApplication::translate("DatabaseViewer", "Gain compensation radius (Constraints view)", Q_NULLPTR));
        doubleSpinBox_gainCompensationRadius->setSuffix(QApplication::translate("DatabaseViewer", " m", Q_NULLPTR));
        label_53->setText(QApplication::translate("DatabaseViewer", "OctoMap", Q_NULLPTR));
        label_54->setText(QApplication::translate("DatabaseViewer", "Voxel size (for clouds and scans)", Q_NULLPTR));
        checkBox_octomap->setText(QString());
        checkBox_grid_regenerateFromSavedGrid->setText(QString());
        doubleSpinBox_voxelSize->setSuffix(QApplication::translate("DatabaseViewer", " m", Q_NULLPTR));
        ...
        comboBox_octomap_rendering_type->insertItems(0, QStringList()
         << QApplication::translate("DatabaseViewer", "Point Cloud", Q_NULLPTR)
         << QApplication::translate("DatabaseViewer", "Cube", Q_NULLPTR)
         << QApplication::translate("DatabaseViewer", "Volume", Q_NULLPTR)
        );
        label_octomap_depth->setText(QApplication::translate("DatabaseViewer", "OctoMap: Tree depth", Q_NULLPTR));
        label_55->setText(QApplication::translate("DatabaseViewer", "Local grid: regenerate from saved grid instead of sensors", Q_NULLPTR));
        label_octomap_empty->setText(QApplication::translate("DatabaseViewer", "Show empty space", Q_NULLPTR));
        label_octomap_empty_3->setText(QApplication::translate("DatabaseViewer", "Ground cell color", Q_NULLPTR));
        label_octomap_empty_2->setText(QApplication::translate("DatabaseViewer", "Obstacle cell color", Q_NULLPTR));
        label_octomap_empty_4->setText(QApplication::translate("DatabaseViewer", "Empty cell color", Q_NULLPTR));
        toolButton_groundColor->setText(QApplication::translate("DatabaseViewer", "...", Q_NULLPTR));
        toolButton_obstacleColor->setText(QApplication::translate("DatabaseViewer", "...", Q_NULLPTR));
        toolButton_emptyColor->setText(QApplication::translate("DatabaseViewer", "...", Q_NULLPTR));
        label_56->setText(QApplication::translate("DatabaseViewer", "Decimation (for images)", Q_NULLPTR));
        spinBox_decimation->setPrefix(QString());
        label_57->setText(QApplication::translate("DatabaseViewer", "Crop radius when filtering empty space from 2d occupancy grid.", Q_NULLPTR));
        spinBox_cropRadius->setSuffix(QApplication::translate("DatabaseViewer", " pixels", Q_NULLPTR));
        label_59->setText(QApplication::translate("DatabaseViewer", "Show probabilistic occupancy grid in Graph View.", Q_NULLPTR));
        checkBox_grid_showProbMap->setText(QString());
        groupBox_posefiltering->setTitle(QApplication::translate("DatabaseViewer", "Pose filtering", Q_NULLPTR));
        doubleSpinBox_posefilteringAngle->setSuffix(QApplication::translate("DatabaseViewer", " degrees", Q_NULLPTR));
        doubleSpinBox_posefilteringRadius->setSuffix(QApplication::translate("DatabaseViewer", " m", Q_NULLPTR));
        label_42->setText(QApplication::translate("DatabaseViewer", "Radius", Q_NULLPTR));
        label_43->setText(QApplication::translate("DatabaseViewer", "Angle", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("DatabaseViewer", "Organized Fast Mesh", Q_NULLPTR));
        label_14->setText(QApplication::translate("DatabaseViewer", "Triangle size", Q_NULLPTR));
        label_12->setText(QApplication::translate("DatabaseViewer", "Angle tolerance", Q_NULLPTR));
        spinBox_mesh_angleTolerance->setSuffix(QApplication::translate("DatabaseViewer", " deg", Q_NULLPTR));
        spinBox_mesh_triangleSize->setSuffix(QApplication::translate("DatabaseViewer", " pix", Q_NULLPTR));
        label_13->setText(QApplication::translate("DatabaseViewer", "Quad", Q_NULLPTR));
        label_17->setText(QApplication::translate("DatabaseViewer", "Fill depth holes: error", Q_NULLPTR));
        spinBox_mesh_depthError->setSuffix(QApplication::translate("DatabaseViewer", " %", Q_NULLPTR));
        checkBox_mesh_quad->setText(QString());
        label_15->setText(QApplication::translate("DatabaseViewer", "Fill depth holes: size", Q_NULLPTR));
        spinBox_mesh_fillDepthHoles->setSuffix(QApplication::translate("DatabaseViewer", " pix", Q_NULLPTR));
        label_20->setText(QApplication::translate("DatabaseViewer", "Min cluster size", Q_NULLPTR));
        spinBox_mesh_minClusterSize->setSuffix(QString());
        toolBox->setItemText(toolBox->indexOf(page_4), QApplication::translate("DatabaseViewer", "Grid/cloud generation", Q_NULLPTR));
        label_32->setText(QApplication::translate("DatabaseViewer", "Intra-session", Q_NULLPTR));
        doubleSpinBox_detectMore_radius->setSuffix(QApplication::translate("DatabaseViewer", " m", Q_NULLPTR));
        label_29->setText(QApplication::translate("DatabaseViewer", "Radius Max", Q_NULLPTR));
        doubleSpinBox_detectMore_angle->setSuffix(QApplication::translate("DatabaseViewer", " degrees", Q_NULLPTR));
        label_30->setText(QApplication::translate("DatabaseViewer", "Angle", Q_NULLPTR));
        label_31->setText(QApplication::translate("DatabaseViewer", "Iterations", Q_NULLPTR));
        label_34->setText(QApplication::translate("DatabaseViewer", "Inter-session", Q_NULLPTR));
        checkBox_detectMore_intraSession->setText(QString());
        checkBox_detectMore_interSession->setText(QString());
        label_36->setText(QApplication::translate("DatabaseViewer", "Radius Min", Q_NULLPTR));
        doubleSpinBox_detectMore_radiusMin->setSuffix(QApplication::translate("DatabaseViewer", " m", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(page_5), QApplication::translate("DatabaseViewer", "Detect more loop closures", Q_NULLPTR));
        label_9->setText(QApplication::translate("DatabaseViewer", "Decimation. Negative decimation is done from RGB size instead of depth size (if depth is smaller than RGB, it may be interpolated depending of the decimation value).", Q_NULLPTR));
        label_11->setText(QApplication::translate("DatabaseViewer", "Max depth", Q_NULLPTR));
        checkBox_icp_from_depth->setText(QString());
        label_7->setText(QApplication::translate("DatabaseViewer", "Generate laser scans from RGB-D images using the following parameters.", Q_NULLPTR));
        label_19->setText(QApplication::translate("DatabaseViewer", "Min depth", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(page_2), QApplication::translate("DatabaseViewer", "Refine", Q_NULLPTR));
        dockWidget_stereoView->setWindowTitle(QApplication::translate("DatabaseViewer", "Stereo view", Q_NULLPTR));
        label_stereo_inliers_name->setText(QApplication::translate("DatabaseViewer", "Inliers:", Q_NULLPTR));
        label_stereo_inliers->setText(QApplication::translate("DatabaseViewer", "0", Q_NULLPTR));
        label_stereo_slopeOutliers_name->setText(QApplication::translate("DatabaseViewer", "Slope outliers:", Q_NULLPTR));
        label_stereo_slopeOutliers->setText(QApplication::translate("DatabaseViewer", "0", Q_NULLPTR));
        label_stereo_disparityOutliers_name->setText(QApplication::translate("DatabaseViewer", "Negative disparity outliers:", Q_NULLPTR));
        label_stereo_disparityOutliers->setText(QApplication::translate("DatabaseViewer", "0", Q_NULLPTR));
        label_stereo_flowOutliers_name->setText(QApplication::translate("DatabaseViewer", "Flow outliers:", Q_NULLPTR));
        label_stereo_flowOutliers->setText(QApplication::translate("DatabaseViewer", "0", Q_NULLPTR));
        dockWidget_view3d->setWindowTitle(QApplication::translate("DatabaseViewer", "3D view", Q_NULLPTR));
        checkBox_showWords->setText(QApplication::translate("DatabaseViewer", "Words", Q_NULLPTR));
        checkBox_showCloud->setText(QApplication::translate("DatabaseViewer", "Cloud", Q_NULLPTR));
        checkBox_showMesh->setText(QApplication::translate("DatabaseViewer", "Mesh", Q_NULLPTR));
        checkBox_showScan->setText(QApplication::translate("DatabaseViewer", "Scan", Q_NULLPTR));
        checkBox_showMap->setText(QApplication::translate("DatabaseViewer", "Map", Q_NULLPTR));
        checkBox_showGrid->setText(QApplication::translate("DatabaseViewer", "Grid", Q_NULLPTR));
        checkBox_odomFrame_3dview->setText(QApplication::translate("DatabaseViewer", "Odom Frame", Q_NULLPTR));
        checkBox_gravity_3dview->setText(QApplication::translate("DatabaseViewer", "Gravity", Q_NULLPTR));
        dockWidget_info->setWindowTitle(QApplication::translate("DatabaseViewer", "Info", Q_NULLPTR));
        dockWidget_coreparameters->setWindowTitle(QApplication::translate("DatabaseViewer", "Core Parameters", Q_NULLPTR));
        dockWidget_statistics->setWindowTitle(QApplication::translate("DatabaseViewer", "Statistics", Q_NULLPTR));
        checkBox_timeStats->setText(QString());
        label_logger_level_3->setText(QApplication::translate("DatabaseViewer", "Time (s) used in figures for x-axis instead of node IDs.", Q_NULLPTR));
        dockWidget_occupancyGridView->setWindowTitle(QApplication::translate("DatabaseViewer", "Occupancy Grid", Q_NULLPTR));
        checkBox_grid_2d->setText(QApplication::translate("DatabaseViewer", "2d Map", Q_NULLPTR));
    } // retranslateUi
