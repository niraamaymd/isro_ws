...
public:
    ...
    {
        ExportDialog->setWindowTitle(QApplication::translate("ExportDialog", "Export...", Q_NULLPTR));
        spinBox_ignored->setSuffix(QString());
        label->setText(QApplication::translate("ExportDialog", "Frames ignored", Q_NULLPTR));
        doubleSpinBox_framerate->setSuffix(QApplication::translate("ExportDialog", " Hz", Q_NULLPTR));
        label_3->setText(QApplication::translate("ExportDialog", "Target frame rate", Q_NULLPTR));
        spinBox_session->setSuffix(QString());
        label_2->setText(QApplication::translate("ExportDialog", "Mapping session (-1 = all)", Q_NULLPTR));
        checkBox_rgb->setText(QApplication::translate("ExportDialog", "RGB images", Q_NULLPTR));
        checkBox_depth->setText(QApplication::translate("ExportDialog", "Depth images", Q_NULLPTR));
        checkBox_depth2d->setText(QApplication::translate("ExportDialog", "Laser scans", Q_NULLPTR));
        checkBox_odom->setText(QApplication::translate("ExportDialog", "Odometry", Q_NULLPTR));
        checkBox_userData->setText(QApplication::translate("ExportDialog", "User data (planned goals)", Q_NULLPTR));
        toolButton_path->setText(QApplication::translate("ExportDialog", "...", Q_NULLPTR));
    } // retranslateUi
