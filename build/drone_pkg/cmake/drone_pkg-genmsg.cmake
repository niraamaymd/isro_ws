...
get_filename_component(_filename "/home/isro/isro_ws/src/drone_pkg/msg/GridDetection.msg" NAME_WE)
add_custom_target(_drone_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_pkg" "/home/isro/isro_ws/src/drone_pkg/msg/GridDetection.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/drone_pkg\")")
  # install generated code
  install(
